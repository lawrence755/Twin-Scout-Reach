...
var TEMPLATES = {
  'initial-sms': {
    ...
    "requiredFields": ["agentFirstName", "senderName", "companyWebsite", "propertyAddress", "city"]
  },
  'followup-sms': {
    "id": "followup-sms",
    "channel": "sms",
    ...
    "requiredFields": ["agentFirstName", "propertyAddress", "city", "senderName"]
  },
  'final-sms': {
    "id": "final-sms",
    "channel": "sms",
    ...
    "requiredFields": ["agentFirstName", "propertyAddress", "senderName", "companyWebsite"]
  },
  'initial-email': {
    "id": "initial-email",
    "channel": "email",
    ...
    "requiredFields": ["agentFirstName", "senderName", "companyWebsite", "propertyAddress", "city", "yearsInBusiness", "googleReviewLink", "senderPhone", "senderEmail"]
  },
  'followup-email': {
    "id": "followup-email",
    "channel": "email",
    ...
    "requiredFields": ["agentFirstName", "propertyAddress", "city", "senderName", "senderPhone", "senderEmail"]
  },
  'final-email': {
    "id": "final-email",
    "channel": "email",
    ...
    "requiredFields": ["agentFirstName", "propertyAddress", "senderPhone", "senderEmail", "handoffPerson", "senderName", "companyWebsite"]
  }
};
